...
import { ShoppingCart, Eye, Flame, Edit3 } from 'lucide-react';

export default function FlashSales({ products, onAddToCart, onQuickView, onEditProduct }) {
      ...
      <div className="flash-sales-box">
        ...
        <div className="flash-sales-header">
          <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
            ...
            <h2 className="section-title">Flash Sales ({flashSaleItems.length})</h2>
          </div>
